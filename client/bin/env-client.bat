...
if exist "%FEDORA_HOME%\client\fcrepo-client-admin-3.8.2-SNAPSHOT.jar" goto clientJarFound
echo ERROR: fcrepo-client-admin-3.8.2-SNAPSHOT.jar not found in %FEDORA_HOME%\client
exit /B 1
:clientJarFound
...
set CP="%FEDORA_HOME%\client\bin;%FEDORA_HOME%\client\fcrepo-client-admin-3.8.2-SNAPSHOT.jar;%FEDORA_HOME%\client\cxf-bundle-2.7.7.jar"

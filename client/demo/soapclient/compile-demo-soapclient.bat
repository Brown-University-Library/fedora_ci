...
"%JAVA_HOME%\bin\javac" -classpath %FEDORA_HOME%;%FEDORA_HOME%\client\fcrepo-client-admin-3.8.2-SNAPSHOT.jar -Djava.endorsed.dirs="%FEDORA_HOME%\client\lib" -sourcepath %FEDORA_HOME%\client %FEDORA_HOME%\client\demo\soapclient\DemoSOAPClient.java

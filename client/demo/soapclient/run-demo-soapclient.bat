...
if not exist "%FEDORA_HOME%\client\fcrepo-client-admin-3.8.2-SNAPSHOT.jar" goto clientNotFound
...
echo Client cannot be found at %FEDORA_HOME%\client\fcrepo-client-admin-3.8.2-SNAPSHOT.jar
goto end
